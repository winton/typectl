...
**Typectl** is a control flow library for preparing arguments and executing functions. The API helps define control flows without async/await, effortlessly optimizing execution order without much planning.
